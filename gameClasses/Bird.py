...
from gameClasses.Portal import Portal
...
class Bird(pygame.sprite.Sprite):
  ...
  def __init__(self, x, y):
    ...
    self.countdown_portal = 0
    self.animatingPortal = False
    self.portal = Portal()

  def open_portal(self):
    if self.countdown_portal <= 0 and self.animatingPortal == False:
      self.animatingPortal = True
      self.countdown_portal = 4
